...
public class GridAdapter extends BaseAdapter {
    ...
    @NonNull
    @Override
    public View getView(final int position, @Nullable View monthView, @NonNull ViewGroup parent) {
                Log.d("xxx", "adapter Calendar at:" +position);
                ...
                TextView cellDate = (TextView) monthView.findViewById(R.id.calendar_date);
